...
int main(int argc, char *argv[]) {
	...
	// TODO: Call the initialize_world function here.
	

	// Step 4: Simulate for the required number of steps, printing the world
	// after each step.
	
	// TODO: Write some sort of loop here that calls your update_world and
	// print_world functions. At the end of each turn, you should either wait
	// for the user to enter a character (if you are in step mode) or sleep
	// for the delay amount of ms.
